        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-right">
                {{ Form::open(array('route' => array('delete_blog', $spinblox_blog->blog_id))) }}
                    {{ link_to_route('edit_blog', 'Edit Blog', array('id' => $spinblox_blog->blog_id), array('class' => 'btn btn-info')) }}
        ...
        <div class="panel-body">
            ...
            <table class="table">    
                ...
                <td rowspan="4" width="300" >
                                <img class="img" src='{{ asset("uploads/photos/" . $spinblox_blog->blog_photo_path ) }}' />
                                </td>
                </tr>                
            </table>
            </div>
